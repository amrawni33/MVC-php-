        ...
        <div class="col-8 mx-auto">
            ...
            <form class="p-5 border mb-5" method="POST" action="<?php url('product/update/' . $row["id"]); ?>">
                <div class="form-group">
                    ...
                    <input type="text" required value="<?php echo $row["id"] ?>" name="id" class="form-control" id="id">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" required value="<?php echo $row["qty"] ?>" class="form-control" name="qty" id="qty">
                </div>
